...
See if the website will allow you download
Next check for an API
then see if they allow scraping via robot.txt
may overload the website
...
Teaching computer to pull a few different things. Scrabpable websites usually have consistent format. 
...
Registrant is extracted from the webpage
html_nodes is saying look for all elements with these descriptors
html_text() gives the text associated with the node
...
df_withdrawals <- df_withdrawals %>% 
  mutate(Registrant = !!the_registrant, # bang bang refers to variable
...
2020 indicates year
0004-0001 indicates facility id
