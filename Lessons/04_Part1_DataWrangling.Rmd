...
> Add notes here: Lakes are stratified, so increases in temperatures increase lake stratification and reduce oxygen levels at lower levels when it is more difficult for lakes to mix.
...
NTL.phys.data.depth.descending <- arrange(NTL.phys.data, desc(depth)) # puts high values first

# arranging changes the order of the data set
...
# reorder columns to put month with the rest of the date variables. Select can also change the order of the columns
