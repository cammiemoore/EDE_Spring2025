...
>  There is a signifcant negative correlation between irridance and depth (p < 0.000). Model explains about 31% of the total variance in irradiance.
...
- quantile quaintile plot. Compares residuals to a normal distribution. If it follows a normal distribution, the residuals should follow the linear line of the q-q plot.
- lower and higher end might differ straight from the line, and that just means there might be a few outliers
