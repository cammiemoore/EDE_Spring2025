...
#1c 
NC2018 <- read.csv(here('Data/Raw/EPAair_O3_NC2018_raw.csv'),
                   stringsAsFactors = TRUE)
NC2019 <- read.csv(here('Data/Raw/EPAair_O3_NC2019_raw.csv'),
                   stringsAsFactors = TRUE)
...
#6
write.csv(NC2018, file = "./Data/Processed/EPAair_O3_NC2018_processed")
write.csv(NC2019, file = "./Data/Processed/EPAair_O3_NC2019_processed")
...
epa_air <- epa_air |> 
  ...
  group_by(Date, Site.Name, AQS_PARAMETER_DESC, COUNTY) |> #ask a question about this because i am confused. is this grouping each row...
  summarise(
...
#11
write.csv(epa_air, file = "./Data/Processed/EPAair_O3_PM25_NC1819_Processed.csv")
