...
```{r boxplot ozone 2018, echo=FALSE, warning=FALSE, fig.align="left", fig.height=4, fig.width=4, fig.cap="Boxplot of Ozone Levels by Month (2018)"}
ozone18 <- epa_data|>
  filter(Year==2018)

plot18 <- ggplot(ozone18)+
...
```{r boxplot ozone 2019, echo=FALSE, warning=FALSE,fig.align="left", fig.height=4, fig.width=4, fig.cap="Boxplot of Ozone Levels by Month (2019)"}

ozone19 <- epa_data|>
  filter(Year==2019)

plot19 <- ggplot(ozone19)+
  geom_boxplot(aes(x = Month, y = Ozone))
